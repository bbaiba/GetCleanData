...
| activity | Activity | Factor: "WALKING", "WALKING_UPSTAIRS", "WALKING_DOWNSTAIRS", "SITTING", "STAYING", "LAYING" |
| tBodyAcc.mean.X | Mean of the time domain signal of the body acceleration in the x-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyAcc.mean.Y | Mean of the time domain signal of the body acceleration in the y-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyAcc.mean.Z | Mean of the time domain signal of the body acceleration in the z-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyAcc.std.X | Standard deviation of the time domain signal of the body acceleration in the x-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyAcc.std.Y | Standard deviation of the time domain signal of the body acceleration in the y-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyAcc.std.Z | Standard deviation of the time domain signal of the body acceleration in the z-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tGravityAcc.mean.X | Mean of the time domain signal of the gravity acceleration in the x-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tGravityAcc.mean.Y | Mean of the time domain signal of the gravity acceleration in the y-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tGravityAcc.mean.Z | Mean of the time domain signal of the gravity acceleration in the z-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tGravityAcc.std.X | Standard deviation of the time domain signal of the gravity acceleration in the x-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tGravityAcc.std.Y | Standard deviation of the time domain signal of the gravity acceleration in the y-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tGravityAcc.std.Z | Standard deviation of the time domain signal of the gravity acceleration in the z-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyAccJerk.mean.X | Mean of the time domain signal of the body acceleration in the x-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyAccJerk.mean.Y | Mean of the time domain signal of the body acceleration in the y-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyAccJerk.mean.Z | Mean of the time domain signal of the body acceleration in the z-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyAccJerk.std.X | Standard deviation of the time domain signal of the body acceleration in the x-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyAccJerk.std.Y | Standard deviation of the time domain signal of the body acceleration in the y-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyAccJerk.std.Z | Standard deviation of the time domain signal of the body acceleration in the z-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyGyro.mean.X | Mean of the time domain signal of the body velocity in the x-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyGyro.mean.Y | Mean of the time domain signal of the body velocity in the y-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyGyro.mean.Z | Mean of the time domain signal of the body velocity in the z-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyGyro.std.X | Standard deviation of the time domain signal of the body velocity in the x-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyGyro.std.Y | Standard deviation of the time domain signal of the body velocity in the y-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyGyro.std.Z | Standard deviation of the time domain signal of the body velocity in the z-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyGyroJerk.mean.X | Mean of the time domain signal of the body velocity in the x-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyGyroJerk.mean.Y | Mean of the time domain signal of the body velocity in the y-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyGyroJerk.mean.Z | Mean of the time domain signal of the body velocity in the z-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyGyroJerk.std.X | Standard deviation of the time domain signal of the body velocity in the x-axis (in xyz space) direction | Normalized value from -1 to 1 |
| tBodyGyroJerk.std.Y | Standard deviation of the time domain signal of the body velocity in the y-axis (in xyz space) direction | Normalized value from -1 to 1 |
...
| fBodyGyro.meanFreq.Y | Mean of the frequency domain signal of the body velocity in the y-axis (in xyz space) direction | Normalized value from -1 to 1 |
